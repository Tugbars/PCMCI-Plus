...
int main(int argc, char **argv)
{
    ...
    for (int32_t i = 0; i < result->n_links; i++)
    {
        ...
        if (link->i == 0 && link->j == 0 && link->tau == 1)
            found_x0_x0 = true;
        else if (link->i == 0 && link->j == 1 && link->tau == 1)
            found_x0_x1 = true;
        else if (link->i == 1 && link->j == 1 && link->tau == 1)
            found_x1_x1 = true;
        else if (link->i == 1 && link->j == 2 && link->tau == 1)
            found_x1_x2 = true;
        else if (link->i == 2 && link->j == 2 && link->tau == 1)
            found_x2_x2 = true;
        else
            false_positives++;
    }
