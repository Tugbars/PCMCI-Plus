...
int main(int argc, char** argv) {
    ...
    /* Initialize */
    srand(12345);
    spy[0] = 0; btc[0] = 0; tlt[0] = 0; vix[0] = 0.2;  /* VIX ~20 level */
    spy[1] = 0; btc[1] = 0; tlt[1] = 0; vix[1] = 0.2;
    spy[2] = 0; btc[2] = 0; tlt[2] = 0; vix[2] = 0.2;
    ...
    /* True links to find */
    typedef struct { int32_t i; int32_t j; int32_t tau; const char* desc; } true_link_t;
