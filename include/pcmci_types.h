...
extern "C"
{
    ...
    /** Correlation method for partial correlation test */
    typedef enum
    {
        PCMCI_CORR_SPEARMAN = 0, /**< Spearman rank correlation (robust, DEFAULT) */
        PCMCI_CORR_PEARSON       /**< Pearson linear correlation (sensitive to outliers) */
    } pcmci_corr_method_t;
    ...
    typedef struct
    {
        ...
        pcmci_corr_method_t corr_method; /**< Correlation method (Spearman/Pearson) */
        double alpha_level;              /**< Significance level for skeleton */
        double alpha_mci;                /**< Significance for MCI (0 = same as alpha_level) */

        /* Robustness (applied automatically) */
        double winsorize_thresh; /**< Winsorization percentile (0.01 = 1%/99%, 0 = disabled) */
